...
<div class="page-content">
    <div class="content-header">
        <h1 class="mb-0">عملاء اللوجستيه</h1>
        <ul class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{route('admin.dashboard')}}">{{trans('dashboard/header.main_dashboard') }}</a>
            </li>
            <li class="breadcrumb-item">
                <a href="{{route('admin.logistic.clients.index')}}">عملاء اللوجستيه</a>
            </li>
        </ul>
    </div>
    <!-- Start Content -->
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    @include('dashboard.admin.logistics.clients.btn.create')
                </div>
                <div class="card-body">
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const otherWrapper = document.getElementById("client_category_other_wrapper");
