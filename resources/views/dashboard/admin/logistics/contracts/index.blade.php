...
<div class="page-content">
    <div class="content-header">
        <h1 class="mb-0">بيانات المركبات</h1>
        <ul class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{route('admin.dashboard')}}">{{trans('dashboard/header.main_dashboard') }}</a>
            </li>
            <li class="breadcrumb-item">
                <a href="{{route('admin.logistic.vehicles.index')}}">المركبات</a>
            </li>
        </ul>
    </div>
    <!-- Start Content -->
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    @include('dashboard.admin.logistics.contracts.btn.create')
                </div>
                <div class="card-body">
...
<script>
    function addTerm() {
        let container = document.querySelector('#createModal .modal-body .col-12');
        let textarea = document.createElement('textarea');
        textarea.name = "terms[]";
        textarea.classList.add('form-control', 'mb-2');
        textarea.rows = 2;
        textarea.placeholder = "اكتب البند هنا...";
